...
class AboutIteration < Neo::Koan
  ...
  # ellie note: the |item| here is a block parameter - each item, for example here, array, is assigned to a block parameter (item)
  # then the code inside the block is executed
  ...
  def test_collect_transforms_elements_of_an_array
    # ellie note: iterates over each item in the array and adds 10 individually to each item
    array = [1, 2, 3]
